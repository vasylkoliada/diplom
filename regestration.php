...
<body>
   ...
   <ul>
            <div class="mme">
              <div style="  background: red; text-align: center; height: 60px !important;  display: flex;">        
...
<div id="regestr" style="margin-left: 20px;"></div>
<div style="margin-left: 40px;">
<form id = "fbgh" method="POST" >
	<p>
	<p><strong>Введіть логін</strong>:</p>
	<input type="text" name="login" id = "login" svalue="<?php echo @$data['login'];?>">
    </p>
    <p>
...
<button type="button" class= "button button1" onclick="Redestr()">Зареєстувати</button></div>
</div>
