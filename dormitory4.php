...
<body>
 <h1>Адміністратор</h1>
   ...
   <div style = "margin-left: 30px;">
     <h1 style=" line-height: 1.5; margin-top: 40px;">Гуртожиток №4:</h1>
   <div>

     <p style="border: 0px; margin: 0px 0px 20px; outline: 0px; padding: 0px; vertical-align: baseline; color: #404040;">В гуртожитку проживають студенти архітектори і будівельники, електроніки.<br />Кількість поверхів: 7
     </p>
 
<p >Кількість місць: 700<br />Гуртожиток кімнатного типу. </p>
<p>
  <strong>Завідуючий:</strong> Зварич Сергій Мирославовича<br /><strong >тел. (032) 238-60-49</strong></p>
    <strong>Адреса:</strong> вул. Лукаша 8<br /> </p>
...
.imgg {
  ...
  <img src="dorm/10.jpg" class = "imgg"/>
   <img src="dorm/6.jpg" class = "imgg" />
  <img src="dorm/9.jpg" class = "imgg"/>
  <img src="dorm/7.jpg" class = "imgg"/>
  <img src="dorm/42706764.jpg" class = "imgg"/>
  <img src="dorm/10.jpg" class = "imgg"/>
