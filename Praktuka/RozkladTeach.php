...
function myFunction() {
    var us = document.getElementById("us").val;
    $.ajax({ 
          type: "POST", 
          url: "RozkladTeach.php", 
          data: {us : us}, 
...
<option value="20">Вчитель:</option>
<option value="21">Сало В.В.</option>
<option value="22">Харко С.Ю</option>
<option value="23">Павлик М.І.</option>
<option value="24">Павлик В.В.</option>
<option value="25">Скугра А.Б.</option>
</select>
</form>
