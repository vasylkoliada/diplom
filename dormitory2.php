...
<body>
 <h1>Адміністратор</h1>
   ...
   <div style = "margin-left: 30px;">
     <h1 style=" line-height: 1.5; margin-top: 40px;">Гуртожиток №3:</h1>
   <div>

     <p style="border: 0px; margin: 0px 0px 20px; outline: 0px; padding: 0px; vertical-align: baseline; color: #404040;">В гуртожитку проживають студенти геодезисти, електроніки та комп'ютерних систем, а також студенти юридичного факультету (9 поверх).<br />Кількість поверхів: 9
     </p>
